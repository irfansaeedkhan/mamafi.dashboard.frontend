...
const TermsAndConditions = () => {
  ...
  return (
    <div className="mx-auto my-6 flex max-h-[90vh] flex-col overflow-y-auto rounded-xl bg-light px-6 py-5 font-inter text-white md:max-h-[95%] md:max-w-[90%]">
      <div
        className="border-gray-700 hover:bg-gray-700/10 group flex size-10 cursor-pointer items-center justify-center rounded-full border transition-all duration-100 hover:border-white"
        onClick={back}
      >
        <HiMiniArrowLeft className="text-xl text-white/30 group-hover:text-white" />
      </div>
      <div className="flex flex-col items-start justify-between gap-2 pb-10 pt-6 lg:flex-row lg:items-center lg:gap-5">
        <h1 className="text-lg text-white md:text-xl">Terms & Conditions</h1>
        <h2>
          Mamafi Club
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-1">
          ...
          <p className="whitespace-pre-wrap text-sm leading-6 text-white">
            Mamafi is a private, anonymous, and unconventional circle, created for individuals
            who can envision new forms of interaction between artificial intelligence, decentralized
            finance, and collective initiative. Access is by direct personal invitation only, issued
            by an existing member. No public access, no advertising, no public claims.
          </p>
        </div>
        <div className="flex flex-col gap-1">
          ...
          <p className="whitespace-pre-wrap text-sm leading-6 text-white">
            ...
            commitment—a symbolic act of joining a vision. By becoming a member of the Club, you are
            co-funding the development and deployment of AI intelligence used to generate
        ...
        <div className="flex flex-col gap-1">
          ...
          <ul className="list-none pl-0">
            <li className={listStyle}>
              <p className="whitespace-pre-wrap text-sm leading-6 text-white">
                Funds contributed support the computational power and AI-driven systems employed in
                DeFi and crypto environments.
              </p>
            </li>
            <li className={listStyle}>
              <p className="whitespace-pre-wrap text-sm leading-6 text-white">
        ...
        <div className="flex flex-col gap-1">
          ...
          <ul className="list-none pl-0">
            ...
            <li className={listStyle}>
              <p className="whitespace-pre-wrap text-sm leading-6 text-white">
                Financial participation is processed through encrypted or blockchain-based channels
        ...
        <div className="flex flex-col gap-1">
          ...
          <ul className="list-none pl-0">
            ...
            <li className={listStyle}>
              <p className="whitespace-pre-wrap text-sm leading-6 text-white">
                No requests for audits, transparency, or accounting will be honored: those who join
                do so on the basis of trust and vision—not entitlement.
              </p>
            </li>
          </ul>
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="whitespace-pre-wrap text-sm leading-6 text-white">
            ...
            not expect stability. This is a place for explorers of the unknown—those willing to risk
            everything to gain what cannot be explained. Welcome to the Club.
          </p>
        </div>
      </div>
    </div>
